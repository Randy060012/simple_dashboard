...
<main class="flex-grow p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
            <div class="flex items-center gap-2">
                <a href="index.html#" class="text-sm font-medium text-slate-700 dark:text-slate-400">NettaAdMoon</a>
            </div>

            <div class="flex items-center gap-2">
                <i class="mgc_right_line text-lg flex-shrink-0 text-slate-400 rtl:rotate-180"></i>
                <a href="index.html#" class="text-sm font-medium text-slate-700 dark:text-slate-400">Menu</a>
            </div>

            <div class="flex items-center gap-2">
                <i class="mgc_right_line text-lg flex-shrink-0 text-slate-400 rtl:rotate-180"></i>
                <a href="index.html#" class="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Dashboard</a>
            </div>
        </div>
    </div>
    <!-- Page Title End -->
            ...
            <div class="card">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="flex-grow">
                            <h5 class="mb-1">Total New Projects </h5>
                            <p>32</p>
                        </div>
                        <div>
                            <button class="text-gray-600 dark:text-gray-400" data-fc-type="dropdown" data-fc-placement="left-start" type="button">
                            ...
                            <div class="flex flex-col gap-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-grow ms-3">
                                        ...
                                        <ul class="flex items-center gap-2">
                                            <li class="list-inline-item"><b>78</b> Total Projects</li>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-grow ms-3">
                                        ...
                                        <ul class="flex items-center gap-2">
                                            <li class="list-inline-item"><b>89</b> Total Projects</li>
                                            <li class="list-inline-item">
                                                <div class="w-1 h-1 rounded bg-gray-400"></div>
                                            </li>
                                            <li class="list-inline-item"><b>6</b> Employees</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-grow ms-3">
                                        ...
                                        <ul class="flex items-center gap-2">
                                            <li class="list-inline-item"><b>32</b> Total Projects</li>
                                            <li class="list-inline-item">
                                                <div class="w-1 h-1 rounded bg-gray-400"></div>
                                            </li>
                                            <li class="list-inline-item"><b>7</b> Employees</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-grow ms-3">
                                        ...
                                        <ul class="flex items-center gap-2">
                                            <li class="list-inline-item"><b>9</b> Total Projects</li>
                                            <li class="list-inline-item">
                                                <div class="w-1 h-1 rounded bg-gray-400"></div>
                                            </li>
                                            <li class="list-inline-item"><b>2</b> Employees</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <div class="py-6">
                    <div class="px-6" data-simplebar style="max-height: 304px;">
                        <div class="space-y-6">
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{asset('admin/assets/images/users/avatar-1.jpg')}}" width="40" alt="Generic placeholder image">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{asset('admin/assets/images/users/avatar-2.jpg')}}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{asset('admin/assets/images/users/avatar-3.jpg')}}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{asset('admin/assets/images/users/avatar-4.jpg')}}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{asset('admin/assets/images/users/avatar-5.jpg')}}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
                            ...
                            <div class="flex items-center">
                                <img class="me-3 rounded-full" src="{{asset('admin/assets/images/users/avatar-6.jpg')}}" width="40" alt="Generic placeholder image">
                                <div class="w-full overflow-hidden">
    ...
    <div class="grid 2xl:grid-cols-4 gap-6 mb-6" style="margin-top:50px;">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="{{asset('admin/assets/images/users/avatar-1.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="{{asset('admin/assets/images/users/avatar-2.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="{{asset('admin/assets/images/users/avatar-3.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="{{asset('admin/assets/images/users/avatar-4.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="{{asset('admin/assets/images/users/avatar-5.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="{{asset('admin/assets/images/users/avatar-6.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="p-6">
                        ...
                        <div class="flex items-end">
                            ...
                            <div class="flex">
                                <a href="javascript:void(0);">
                                    <img src="{{asset('admin/assets/images/users/avatar-7.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                                <a href="javascript:void(0);" class="-ms-2">
                                    <img src="{{asset('admin/assets/images/users/avatar-8.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                </a>
                            </div>
                        </div>
                    </div>
