...
<div class="srcollbar" data-simplebar>
    <ul class="menu" data-fc-type="accordion">
        ...
        <li class="menu-item">
            ...
            <ul class="sub-menu hidden">
                <li class="menu-item">
                    <a href="layout-hover-view.html"  class="menu-link">
                        <span class="menu-text">Hovered Menu</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="layout-icon-view.html"  class="menu-link">
                        <span class="menu-text">Icon View Menu</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="layout-compact-view.html"  class="menu-link">
                        <span class="menu-text">Compact Menu</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="layout-mobile-view.html"  class="menu-link">
                        <span class="menu-text">Mobile View Menu</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="layout-hidden.html"  class="menu-link">
