<header class="app-header flex items-center px-4 gap-3">
                ...
                <a href="index.html" class="logo-box">
                    ...
                    <div class="logo-light">
                        <img src="{{asset('admin/assets/images/logo-light.png')}}" class="logo-lg h-6" alt="Light logo">
                        <img src="{{asset('admin/assets/images/logo-sm.png')}}" class="logo-sm" alt="Small logo">
                    </div>

                    <!-- Dark Brand Logo -->
                    <div class="logo-dark">
                        <img src="{{asset('admin/assets/images/logo-dark.png')}}" class="logo-lg h-6" alt="Dark logo">
                        <img src="{{asset('admin/assets/images/logo-sm.png')}}" class="logo-sm" alt="Small logo">
                    </div>
                </a>
                ...
                <div class="relative">
                    <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link p-2 fc-dropdown">
                        <span class="flex items-center justify-center h-6 w-6">
                            <img src="{{asset('admin/assets/images/flags/us.jpg')}}" alt="user-image" class="h-4 w-6">
                        </span>
                    </button>
                        ...
                        <div class="p-4 h-80" data-simplebar>
                            ...
                            <a href="javascript:void(0);" class="block mb-4">
                                <div class="card-body">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{asset('admin/assets/images/users/avatar-2.jpg')}}" class="rounded-full h-9 w-9" alt="">
                                        </div>
                                        <div class="flex-grow truncate ms-2">
                            ...
                            <a href="javascript:void(0);" class="block">
                                <div class="card-body">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{asset('admin/assets/images/users/avatar-4.jpg')}}" class="rounded-full h-9 w-9" alt="">
                                        </div>
                                        <div class="flex-grow truncate ms-2">
                ...
                <div class="relative">
                    <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link">
                        <img src="{{asset('admin/assets/images/users/user-6.jpg')}}" alt="user-image" class="rounded-full h-10">
                    </button>
